    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 mt-3">
                ...
                <section>
                    <h3 class="mt-4 mb-3 color-general">Requisitos</h3>
                    <ul>
                ...
                <section>
                    <h3 class="mt-4 mb-3 color-general">Descripción</h3>
                    <div class="">
                            ...
                            @else
                                @if ($course->price->value == 0)
                                    ...
                                    <form action="{{ route('visitador.course.enrolled', ['course' => $course]) }}"
                                        method="POST">
                                        @csrf
                                        <button class="mi-boton general mt-1 w-100" type="submit">Llevar este curso</button>
                                    </form>
                                @else
                                    <p style="font-size: 22px;font-weight: bold" class="color-general">
