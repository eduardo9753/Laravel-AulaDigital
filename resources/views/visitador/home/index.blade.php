                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="social-icons">
                                ...
                                <div class="d-flex">
                                    ...
                                    <a target="_blank" href="https://www.facebook.com/profile.php?id=61557637935578&is_tour_dismissed"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <ul class="list-footer">
                                        ...
                                        <li><a href="https://preunicursos.com/course/show/fisica"
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <p class="mb-0 text-small pt-1">Copyright © <a href="https://preunicursos.com/"
                                    class="text-white" target="_blank">PreuniCursos</a> @php
                                        echo date('Y');
                                    @endphp </p>
                        </div>
                        <div>
